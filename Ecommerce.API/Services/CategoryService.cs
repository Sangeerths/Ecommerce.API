...
PaginationParams paginationParams)
    {
        var query = _dbContext.Categories.Where(c => !c.IsDeleted).AsQueryable();
    ...
    {
        var category = await _dbContext.Categories.FirstOrDefaultAsync(c => c.CategoryId == categoryId && !c.IsDeleted);
        if (category == null)
        {
            return null;
        }
